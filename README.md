...
Nesse repositorio foi Recriando a página inicial do Instagram.Foi utilizado HTML + CSS com Flexbox.

### Aceito sugetões, Os requisitos são:

-   [HTML básico](https://www.w3schools.com/html/)
-   [CSS básico](https://developer.mozilla.org/pt-BR/docs/Web/CSS)

Os icones utilizados nesse projeto você encontra em https://www.flaticon.com/br/
